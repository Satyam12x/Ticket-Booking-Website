    ...
    return (
        <div className="booking-layout">
            <div className="booking-left">
                ...
                <h2 className="booking-title">Made your show booking experience effortless!</h2>
                <p className="booking-description">
                    Theatre show tickets, now simpler and faster than ever — so you can focus on the magic of the stage.
                </p>
                ...
                {isLoading ? (
                    ...
                    <div className="event-details">
                        <p><strong>Date:</strong> {new Date(selectedEventDetails.date).toLocaleDateString("en-US", {
                            weekday: "long",
                            year: "numeric",
                            month: "long",
                            day: "numeric",
                        })}</p>
                        <p><strong>Time:</strong> {selectedEventDetails.time}</p>
                ...
                <Link
                    ...
                    className={`book-button ${!selectedEvent || isLoading ? "disabled" : ""}`}
                >
                    Book Seats Now
                </Link>
            </div>
